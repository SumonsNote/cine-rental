...
export default function CartDetailsModal({ onClose }) {
  ...
  function handleDeleteCart(event, item) {
    ...
    toast.warning(`${item.title} is removed the cart.`);
  }
  return (
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[420px] sm:max-w-[600px] lg:max-w-[790px] p-4 max-h-[90vh] overflow-auto">
        <div className="bg-white shadow-md dark:bg-[#12141D] rounded-2xl overflow-hidden p-5 md:p-9">
          ...
          <div className="space-y-8 lg:space-y-12 max-h-[450px] overflow-auto mb-10 lg:mb-14">
            {state.cartData.length === 0 ? (
              <div className="flex items-center justify-evenly">
                ...
                <span className="text-4xl">The cart is empty!</span>
              </div>
            ) : (
          ...
          <div className="flex items-center justify-end gap-2">
            <a className="cursor-pointer rounded-md p-2 md:px-4 inline-flex items-center space-x-2 bg-primary text-[#171923] text-sm">
